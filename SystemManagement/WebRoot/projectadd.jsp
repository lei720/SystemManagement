...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<a href="myacount.action"><div class="showhide-account"><img src="images/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" title="<s:property value="#sesstion.admin"/>"/></div></a>
			<div class="nav-divider">&nbsp;</div>
...
<tr>
	...
	<td>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		  <tr>
		<th >ProjectName:</th>
		<td><input type="text" name="pro.projectname" /><s:property value="#request.erropage"/></td>
		</tr>
		
		<tr>
		<th colspan="2">
			<input type="submit" name="submit" value="" class="form-submit" />
			<input type="reset" name="sunbmit" value="" class="form-reset"  />		</th>
		</tr>
