	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
				<form id="formt" action="editeacount.action" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		  <tr>
		<th >Admin's Name:</th>
		<td><input id="fname" type="text" name="admin.adminname"  value="<s:property value="admin.adminname"/>"/><s:property value="#request.nameerro"/></td>
		</tr>
		  <tr>
		<th >Admin's Password:</th>
		<td><input id="test" type="text" name="admin.adminpassword"  value="<s:property value="admin.adminpassword"/>"/><s:property value="#request.paswderro"/></td>
		</tr>
		
		 
		  <tr>
		<th colspan="2">
			<input type="submit" style="width: 44px; height: 23px;"></input>
			
			<input id="reset" value="重置" onclick="myFunction()" type="button" style="width: 44px; height: 23px;"></input>
				</th>
		</tr>
