...
<tr>
	...
	<td>
		...
		<form action="editeSingleProject.action" method="post">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		
		<tr>
			<th valign="top">Project's name:</th>
			<td><input type="text" id="projectname" name="pro.projectname" value="<s:property value="pro.projectname"/>"/><s:property value="#request.namerro"/></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
		<th valign="top">Project's user:</th>
		<td><s:iterator value="%{pro.getUsers()}" id="id" status="stadus">
		
		<input type="text" name="<s:property value="#id.userid"/>"  value="<s:property value="#id.username"/>"/>
		</s:iterator>
		</td>
		<td></td>
		</tr>
	...
	<tr>
		...
		<td valign="top">
			...
			<input type="text" onclick="myFunction2()" value="" class="form-reset"  />
		</td>
		<td></td>
	</tr>
	</table>
