...
var t=form1.iframe.value;
var y=form1.test.value;
...
document.getElementById("p3").style.display="none";
			...
			document.getElementById("p").style.display="none"; 
							...
							document.getElementById("p2").style.display="none";
							     document.getElementById("form1").action="adduser.action";
							         form1.submit();
...
<div class="nav-outer"> 
		...
		<div class="select_sub">
			<ul class="sub">
				...
				<li><a href="userview.action">Delete User</a></li>
			</ul>
		</div>
...
<tr>
	...
	<td>
		...
		<tr>
			<th >User's Name:</th>
			<td><input id="test" type="text" class="inp-form" name="user.username"/></td>
			<td><p id="p3"></p></td>
		</tr>
		<tr>
	
			<th >User's working hours:(单位)/月:</th>
			<td><input id="fname" type="text" name="user.userpagenum" class="inp-form" /></td>
			<td><p id="p"></p></td>
	...
	<tr>
		...
		<td><input id="iframe" name="projectid" type="text" class="inp-form" /><s:property value="#request.projecterro"/></td>
		<td><p id="p2"></p></td>
		</tr>
	...
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<input type="button" onclick="myFunction()" value="" class="form-submit" />
